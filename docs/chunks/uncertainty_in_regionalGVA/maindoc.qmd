...
-   The [main R code script here](https://github.com/DanOlner/RegEconWorks/blob/master/code/ABS_error_rates.R) has sections clearly marked where Claude Code (CC) was used to output code, mostly for visualisations.
