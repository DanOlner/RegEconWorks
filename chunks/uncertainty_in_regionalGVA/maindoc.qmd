...
-   This is not standard practice mostly due to the constrictions of the System of National Accounts (globally agreed so extremely slow to change) [@coyle2014]. But it is not an either/or situation. Both accounts single point data and error-bar approaches can be used.
